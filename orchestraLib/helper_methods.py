...
def get_nxt(chord_type, char):
    ...
    if chord_type == 'chord_3':
        return '{' + \
            f'{char}1/4,{chords_order[pos + 2]}1/4,{chords_order[pos + 4]}1/4' + '}'

    if chord_type == 'chord_special':
        return '{' + \
            f'{char}1/4,{chords_order[pos + 1]}1/4,{chords_order[pos + 3]}1/4' + '}'

    if chord_type == 'chord_3_2':
        return '{' + \
            f'{char}1/4,{chords_order[pos + 3]}1/4,{chords_order[pos + 5]}1/4' + '}'
...
def preprocess_img(img_path):
    ...
    # 3. Binarize image using combination of (global + otsu) thresholding and
    # save it #
